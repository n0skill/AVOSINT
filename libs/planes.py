...
URL_CH = 'https://app02.bazl.admin.ch/web/bazl-backend/lfr'
...
class Plane:
    ...
    def get_owner(self):
        ...
        if self.numb.startswith('HB-'):
            ...
            data = '{"page_result_limit":10,"current_page_number":1,"sort_list":"registration","language":"fr","queryProperties":{"registration":"'+self.numb[3:] + '","aircraftStatus":["Registered","Reserved","Reservation Expired","Registration in Progress"]}}}'
            ...
            if response.status_code == 200:
                ...
                street_n    = str(addr.get('streetNo'))
